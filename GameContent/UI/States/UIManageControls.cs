...
namespace Terraria.GameContent.UI.States
{
  public class UIManageControls : UIState
  {
    ...
    private void AssembleBindPanels()
    {
      ...
      this._bindsKeyboard.Add((UIElement) this.CreateBindingGroup(0, bindings1, InputMode.Keyboard));
      this._bindsKeyboard.Add((UIElement) this.CreateBindingGroup(1, bindings4, InputMode.Keyboard));
      this._bindsKeyboard.Add((UIElement) this.CreateBindingGroup(2, bindings3, InputMode.Keyboard));
      this._bindsGamepad.Add((UIElement) this.CreateBindingGroup(0, bindings2, InputMode.XBoxGamepad));
      this._bindsGamepad.Add((UIElement) this.CreateBindingGroup(1, bindings4, InputMode.XBoxGamepad));
      this._bindsGamepad.Add((UIElement) this.CreateBindingGroup(2, bindings3, InputMode.XBoxGamepad));
      this._bindsGamepad.Add((UIElement) this.CreateBindingGroup(3, bindings5, InputMode.XBoxGamepad));
      this._bindsGamepad.Add((UIElement) this.CreateBindingGroup(4, bindings6, InputMode.XBoxGamepad));
      this._bindsKeyboardUI.Add((UIElement) this.CreateBindingGroup(0, bindings1, InputMode.KeyboardUI));
      this._bindsKeyboardUI.Add((UIElement) this.CreateBindingGroup(1, bindings4, InputMode.KeyboardUI));
      this._bindsKeyboardUI.Add((UIElement) this.CreateBindingGroup(2, bindings3, InputMode.KeyboardUI));
      this._bindsGamepadUI.Add((UIElement) this.CreateBindingGroup(0, bindings2, InputMode.XBoxGamepadUI));
      this._bindsGamepadUI.Add((UIElement) this.CreateBindingGroup(1, bindings4, InputMode.XBoxGamepadUI));
      this._bindsGamepadUI.Add((UIElement) this.CreateBindingGroup(2, bindings3, InputMode.XBoxGamepadUI));
      this._bindsGamepadUI.Add((UIElement) this.CreateBindingGroup(3, bindings5, InputMode.XBoxGamepadUI));
      this._bindsGamepadUI.Add((UIElement) this.CreateBindingGroup(4, bindings6, InputMode.XBoxGamepadUI));
    }
    ...
    private void SetupGamepadPoints(SpriteBatch spriteBatch)
    {
      ...
      point2.Down = 3006;
      num = 3002;
      UILinkPoint point3 = UILinkPointNavigator.Points[3002];
      point3.Unlink();
      point3.Left = 3001;
      point3.Right = 3004;
      point3.Down = 3006;
      num = 3004;
      UILinkPoint point4 = UILinkPointNavigator.Points[3004];
      point4.Unlink();
      point4.Left = 3002;
      point4.Right = 3005;
      point4.Down = 3006;
      num = 3005;
      UILinkPoint point5 = UILinkPointNavigator.Points[3005];
      point5.Unlink();
      point5.Left = 3004;
      point5.Right = 3003;
      point5.Down = 3006;
      num = 3003;
      UILinkPoint point6 = UILinkPointNavigator.Points[3003];
      point6.Unlink();
      point6.Left = 3005;
      point6.Down = 3006;
      ...
      for (int index2 = 0; index2 < snapPoints.Count; ++index2)
      {
        int ID1 = index1 + 6 + index2;
        if (snapPoints[index2].Name == "Thin")
        {
          UILinkPoint point7 = UILinkPointNavigator.Points[ID1];
          point7.Unlink();
          UILinkPointNavigator.SetPosition(ID1, snapPoints[index2].Position);
          point7.Right = ID1 + 1;
          point7.Down = index2 < snapPoints.Count - 2 ? ID1 + 2 : index1;
          point7.Up = index2 < 2 ? index1 + 1 : (snapPoints[index2 - 1].Name == "Wide" ? ID1 - 1 : ID1 - 2);
          UILinkPointNavigator.Points[index1].Up = ID1;
          UILinkPointNavigator.Shortcuts.FANCYUI_HIGHEST_INDEX = ID1;
          ++index2;
          if (index2 < snapPoints.Count)
          {
            int ID2 = index1 + 6 + index2;
            UILinkPoint point8 = UILinkPointNavigator.Points[ID2];
            point8.Unlink();
            UILinkPointNavigator.SetPosition(ID2, snapPoints[index2].Position);
            point8.Left = ID2 - 1;
            point8.Down = index2 < snapPoints.Count - 1 ? (snapPoints[index2 + 1].Name == "Wide" ? ID2 + 1 : ID2 + 2) : index1;
            point8.Up = index2 < 2 ? index1 + 1 : ID2 - 2;
        ...
        else
        {
          ...
          point7.Unlink();
          UILinkPointNavigator.SetPosition(ID1, snapPoints[index2].Position);
          point7.Down = index2 < snapPoints.Count - 1 ? ID1 + 1 : index1;
          point7.Up = index2 < 1 ? index1 + 1 : (snapPoints[index2 - 1].Name == "Wide" ? ID1 - 1 : ID1 - 2);
          UILinkPointNavigator.Shortcuts.FANCYUI_HIGHEST_INDEX = ID1;
          UILinkPointNavigator.Points[index1].Up = ID1;
        }
      }
