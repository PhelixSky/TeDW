...
namespace Terraria
{
  public class Lighting
  {
    ...
    public static void PreRenderPhase()
    {
      ...
      if (Main.wof >= 0)
      {
        if (Main.player[Main.myPlayer].gross)
        {
          try
          {
            ...
            float num14 = (float) (1.0 * (double) Main.demonTorch + 0.5 * (1.0 - (double) Main.demonTorch));
            float num15 = num13 * 0.2f;
            float num16 = 0.03f;
            float num17 = num14 * 0.3f;
            for (int index1 = num11; index1 <= num12; ++index1)
            {
              ...
              {
                Lighting.LightingState lightingState = state[index2 - Lighting.firstToLightY];
                if ((double) lightingState.r2 < (double) num15)
                  lightingState.r2 = num15;
                if ((double) lightingState.g2 < (double) num16)
                  lightingState.g2 = num16;
                if ((double) lightingState.b2 < (double) num17)
                  lightingState.b2 = num17;
              }
            }
          }
          catch
      ...
      int num18 = (lastToLightX - firstToLightX - Main.zoneX) / 2;
      int num19 = (lastToLightY - firstToLightY - Main.zoneY) / 2;
      ...
      for (int index1 = firstToLightX; index1 < lastToLightX; ++index1)
      {
        ...
        for (int index2 = firstToLightY; index2 < lastToLightY; ++index2)
        {
          ...
          if (tile.active())
          {
            if (index1 > firstToLightX + num18 && index1 < lastToLightX - num18 && (index2 > firstToLightY + num19 && index2 < lastToLightY - num19))
            {
              ...
              else
              {
                if ((uint) type <= 318U)
                {
                  if ((uint) type <= 215U)
                  {
                    ...
                    {
                      if ((int) tile.frameX == 306 || (int) tile.frameX == 324)
                      {
                  ...
                  if ((uint) type <= 350U)
                  {
                    switch (type)
                    {
                      ...
                      case 350:
                        ...
                        float num20 = (float) (-Math.Cos((int) (num17 / 6.283) % 3 == 1 ? num17 : 0.0) * 0.1 + 0.1);
                        num8 = num20;
                        num9 = num20;
                        num10 = num20;
                        goto label_419;
