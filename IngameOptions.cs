  ...
  public static class IngameOptions
  {
    ...
    public static void Draw(Main mainInstance, SpriteBatch sb)
    {
      ...
      else
      {
        ...
        int num1 = 20;
        IngameOptions._GUIHover = new Rectangle((int) ((double) vector2_4.X - 20.0), (int) ((double) vector2_4.Y - 20.0), (int) ((double) vector2_3.X + 40.0), (int) ((double) vector2_3.Y + 40.0));
        Utils.DrawInvBG(sb, vector2_4.X - 20f, vector2_4.Y - 20f, vector2_3.X + 40f, vector2_3.Y + 40f, new Color(33, 15, 91, (int) byte.MaxValue) * 0.685f);
        if (new Rectangle((int) vector2_4.X - 20, (int) vector2_4.Y - 20, (int) vector2_3.X + 40, (int) vector2_3.Y + 40).Contains(new Point(Main.mouseX, Main.mouseY)))
        ...
        IngameOptions.noSound = false;
        bool flag2;
        int num4 = (flag2 = SocialAPI.Network != null && SocialAPI.Network.CanInvite()) ? 1 : 0;
        int num5 = 5 + num4;
        ...
        if (IngameOptions.category == 0)
        {
          int num7 = 0;
          anchor2.X -= 70f;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[99] + " " + (object) Math.Round((double) Main.musicVolume * 100.0) + "%", 0, anchor2, offset2, IngameOptions.rightScale[0], (float) (((double) IngameOptions.rightScale[0] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
            if (IngameOptions.rightLock == -1)
              IngameOptions.notBar = true;
            IngameOptions.noSound = true;
            IngameOptions.rightHover = num7;
          }
          ...
          float num8 = IngameOptions.DrawValueBar(sb, 0.75f, Main.musicVolume, 0);
          if ((IngameOptions.inBar || IngameOptions.rightLock == num7) && !IngameOptions.notBar)
          {
            IngameOptions.rightHover = num7;
            if (Main.mouseLeft && IngameOptions.rightLock == num7)
          ...
          if (IngameOptions.rightHover == num7)
            UILinkPointNavigator.Shortcuts.OPTIONS_BUTTON_SPECIALFEATURE = 2;
          int i1 = num7 + 1;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[98] + " " + (object) Math.Round((double) Main.soundVolume * 100.0) + "%", i1, anchor2, offset2, IngameOptions.rightScale[i1], (float) (((double) IngameOptions.rightScale[i1] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
            if (IngameOptions.rightLock == -1)
              IngameOptions.notBar = true;
          ...
          IngameOptions.valuePosition.X = (float) ((double) vector2_4.X + (double) vector2_3.X - (double) (num1 / 2) - 20.0);
          IngameOptions.valuePosition.Y -= 3f;
          float num9 = IngameOptions.DrawValueBar(sb, 0.75f, Main.soundVolume, 0);
          ...
          int i2 = i1 + 1;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[119] + " " + (object) Math.Round((double) Main.ambientVolume * 100.0) + "%", i2, anchor2, offset2, IngameOptions.rightScale[i2], (float) (((double) IngameOptions.rightScale[i2] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
            if (IngameOptions.rightLock == -1)
              IngameOptions.notBar = true;
          ...
          IngameOptions.valuePosition.X = (float) ((double) vector2_4.X + (double) vector2_3.X - (double) (num1 / 2) - 20.0);
          IngameOptions.valuePosition.Y -= 3f;
          float num10 = IngameOptions.DrawValueBar(sb, 0.75f, Main.ambientVolume, 0);
          ...
          int i3 = i2 + 1;
          anchor2.X += 70f;
          if (IngameOptions.DrawRightSide(sb, Main.autoSave ? Lang.menu[67] : Lang.menu[68], i3, anchor2, offset2, IngameOptions.rightScale[i3], (float) (((double) IngameOptions.rightScale[i3] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
          ...
          int i4 = i3 + 1;
          if (IngameOptions.DrawRightSide(sb, Main.autoPause ? Lang.menu[69] : Lang.menu[70], i4, anchor2, offset2, IngameOptions.rightScale[i4], (float) (((double) IngameOptions.rightScale[i4] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
          ...
          int i5 = i4 + 1;
          if (IngameOptions.DrawRightSide(sb, Main.showItemText ? Lang.menu[71] : Lang.menu[72], i5, anchor2, offset2, IngameOptions.rightScale[i5], (float) (((double) IngameOptions.rightScale[i5] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
          ...
          int i6 = i5 + 1;
          if (IngameOptions.DrawRightSide(sb, Main.cSmartCursorToggle ? Lang.menu[121] : Lang.menu[122], i6, anchor2, offset2, IngameOptions.rightScale[i6], (float) (((double) IngameOptions.rightScale[i6] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
          ...
          int i7 = i6 + 1;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[123] + " " + Lang.menu[124 + Main.invasionProgressMode], i7, anchor2, offset2, IngameOptions.rightScale[i7], (float) (((double) IngameOptions.rightScale[i7] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
          ...
          int i8 = i7 + 1;
          if (IngameOptions.DrawRightSide(sb, Main.placementPreview ? Lang.menu[128] : Lang.menu[129], i8, anchor2, offset2, IngameOptions.rightScale[i8], (float) (((double) IngameOptions.rightScale[i8] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
          ...
          int i9 = i8 + 1;
          if (IngameOptions.DrawRightSide(sb, ChildSafety.Disabled ? Lang.menu[132] : Lang.menu[133], i9, anchor2, offset2, IngameOptions.rightScale[i9], (float) (((double) IngameOptions.rightScale[i9] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
          ...
          int i10 = i9 + 1;
          if (IngameOptions.DrawRightSide(sb, ItemSlot.Options.HighlightNewItems ? Lang.inter[117] : Lang.inter[116], i10, anchor2, offset2, IngameOptions.rightScale[i10], (float) (((double) IngameOptions.rightScale[i10] - (double) num2) / ((double) scale - (double) num2)), new Color()))
          {
        ...
        if (IngameOptions.category == 2)
        {
          ...
          anchor2.X -= 30f;
          int num7 = 0;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[74], 0, anchor2, offset2, IngameOptions.rightScale[0], (float) (((double) IngameOptions.rightScale[0] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 0 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i1;
            if (flag1)
              Main.setKey = num7;
          ...
          int i2 = i1 + 1;
          int num8 = 1;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[75], i2, anchor2, offset2, IngameOptions.rightScale[i2], (float) (((double) IngameOptions.rightScale[i2] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 1 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i2;
            if (flag1)
              Main.setKey = num8;
          ...
          int i3 = i2 + 1;
          int num9 = 2;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[76], i3, anchor2, offset2, IngameOptions.rightScale[i3], (float) (((double) IngameOptions.rightScale[i3] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 2 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i3;
            if (flag1)
              Main.setKey = num9;
          ...
          int i4 = i3 + 1;
          int num10 = 3;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[77], i4, anchor2, offset2, IngameOptions.rightScale[i4], (float) (((double) IngameOptions.rightScale[i4] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 3 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i4;
            if (flag1)
              Main.setKey = num10;
          ...
          int i5 = i4 + 1;
          int num11 = 4;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[78], i5, anchor2, offset2, IngameOptions.rightScale[i5], (float) (((double) IngameOptions.rightScale[i5] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 4 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i5;
            if (flag1)
              Main.setKey = num11;
          ...
          int i6 = i5 + 1;
          int num12 = 5;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[79], i6, anchor2, offset2, IngameOptions.rightScale[i6], (float) (((double) IngameOptions.rightScale[i6] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 5 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i6;
            if (flag1)
              Main.setKey = num12;
          ...
          int i7 = i6 + 1;
          int num13 = 6;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[80], i7, anchor2, offset2, IngameOptions.rightScale[i7], (float) (((double) IngameOptions.rightScale[i7] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 6 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i7;
            if (flag1)
              Main.setKey = num13;
          ...
          int i8 = i7 + 1;
          int num14 = 7;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[81], i8, anchor2, offset2, IngameOptions.rightScale[i8], (float) (((double) IngameOptions.rightScale[i8] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 7 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i8;
            if (flag1)
              Main.setKey = num14;
          ...
          int i9 = i8 + 1;
          int num15 = 8;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[82], i9, anchor2, offset2, IngameOptions.rightScale[i9], (float) (((double) IngameOptions.rightScale[i9] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 8 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i9;
            if (flag1)
              Main.setKey = num15;
          ...
          int i10 = i9 + 1;
          int num16 = 9;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[83], i10, anchor2, offset2, IngameOptions.rightScale[i10], (float) (((double) IngameOptions.rightScale[i10] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 9 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i10;
            if (flag1)
              Main.setKey = num16;
          ...
          int i11 = i10 + 1;
          int num17 = 10;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[84], i11, anchor2, offset2, IngameOptions.rightScale[i11], (float) (((double) IngameOptions.rightScale[i11] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 10 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i11;
            if (flag1)
              Main.setKey = num17;
          ...
          int i12 = i11 + 1;
          int num18 = 11;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[85], i12, anchor2, offset2, IngameOptions.rightScale[i12], (float) (((double) IngameOptions.rightScale[i12] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 11 ? Color.Gold : new Color()))
          {
          ...
          int i13 = i12 + 1;
          int num19 = 12;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[120], i13, anchor2, offset2, IngameOptions.rightScale[i13], (float) (((double) IngameOptions.rightScale[i13] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 12 ? Color.Gold : new Color()))
          {
          ...
          int i14 = i13 + 1;
          int num20 = 13;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[130], i14, anchor2, offset2, IngameOptions.rightScale[i14], (float) (((double) IngameOptions.rightScale[i14] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 13 ? Color.Gold : new Color()))
          {
        ...
        if (IngameOptions.category == 3)
        {
          ...
          anchor2.X -= 30f;
          int num7 = 0;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[106], 0, anchor2, offset2, IngameOptions.rightScale[0], (float) (((double) IngameOptions.rightScale[0] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 0 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i1;
            if (flag1)
              Main.setKey = num7;
          ...
          int i2 = i1 + 1;
          int num8 = 1;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[107], i2, anchor2, offset2, IngameOptions.rightScale[i2], (float) (((double) IngameOptions.rightScale[i2] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 1 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i2;
            if (flag1)
              Main.setKey = num8;
          ...
          int i3 = i2 + 1;
          int num9 = 2;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[108], i3, anchor2, offset2, IngameOptions.rightScale[i3], (float) (((double) IngameOptions.rightScale[i3] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 2 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i3;
            if (flag1)
              Main.setKey = num9;
          ...
          int i4 = i3 + 1;
          int num10 = 3;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[109], i4, anchor2, offset2, IngameOptions.rightScale[i4], (float) (((double) IngameOptions.rightScale[i4] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 3 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i4;
            if (flag1)
              Main.setKey = num10;
          ...
          int i5 = i4 + 1;
          int num11 = 4;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[110], i5, anchor2, offset2, IngameOptions.rightScale[i5], (float) (((double) IngameOptions.rightScale[i5] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 4 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i5;
            if (flag1)
              Main.setKey = num11;
          ...
          int i6 = i5 + 1;
          int num12 = 5;
          if (IngameOptions.DrawRightSide(sb, Lang.menu[111], i6, anchor2, offset2, IngameOptions.rightScale[i6], (float) (((double) IngameOptions.rightScale[i6] - (double) num2) / ((double) scale - (double) num2)), Main.setKey == 5 ? Color.Gold : new Color()))
          {
            IngameOptions.rightHover = i6;
            if (flag1)
              Main.setKey = num12;
    ...
    public static bool DrawValue(SpriteBatch sb, string txt, int i, float scale, Color over = new Color())
    {
      ...
      bool flag;
      if (flag = rectangle.Contains(new Point(Main.mouseX, Main.mouseY)))
        color = Color.White;
      if (over != new Color())
        color = over;
