...
namespace Terraria
{
  public static class Minecart
  {
    ...
    public static void Initialize()
    {
      ...
      int num1 = 0;
      Minecart._leftSideConnection[0] = -1;
      Minecart._rightSideConnection[0] = -1;
      Minecart._tileHeight[0][0] = -4;
      Minecart._tileHeight[0][7] = -4;
      Minecart._texturePosition[0] = new Vector2(0.0f, 0.0f);
      num1 = 1;
      Minecart._leftSideConnection[1] = 1;
      Minecart._rightSideConnection[1] = 1;
      Minecart._texturePosition[1] = new Vector2(1f, 0.0f);
      int index3 = 2;
      Minecart._leftSideConnection[2] = -1;
      Minecart._rightSideConnection[2] = 1;
      for (int index1 = 0; index1 < 4; ++index1)
        Minecart._tileHeight[index3][index1] = -1;
      Minecart._texturePosition[index3] = new Vector2(2f, 1f);
      int index4 = index3 + 1;
      Minecart._leftSideConnection[index4] = 1;
      Minecart._rightSideConnection[index4] = -1;
      for (int index1 = 4; index1 < 8; ++index1)
        Minecart._tileHeight[index4][index1] = -1;
      Minecart._texturePosition[index4] = new Vector2(3f, 1f);
      int index5 = index4 + 1;
      Minecart._leftSideConnection[index5] = 2;
      Minecart._rightSideConnection[index5] = 1;
      Minecart._tileHeight[index5][0] = 1;
      Minecart._tileHeight[index5][1] = 2;
      Minecart._tileHeight[index5][2] = 3;
      Minecart._tileHeight[index5][3] = 3;
      Minecart._tileHeight[index5][4] = 4;
      Minecart._tileHeight[index5][5] = 4;
      Minecart._texturePosition[index5] = new Vector2(0.0f, 2f);
      int index6 = index5 + 1;
      Minecart._leftSideConnection[index6] = 1;
      Minecart._rightSideConnection[index6] = 2;
      Minecart._tileHeight[index6][2] = 4;
      Minecart._tileHeight[index6][3] = 4;
      Minecart._tileHeight[index6][4] = 3;
      Minecart._tileHeight[index6][5] = 3;
      Minecart._tileHeight[index6][6] = 2;
      Minecart._tileHeight[index6][7] = 1;
      Minecart._texturePosition[index6] = new Vector2(1f, 2f);
      int index7 = index6 + 1;
      Minecart._leftSideConnection[index7] = 1;
      Minecart._rightSideConnection[index7] = 0;
      Minecart._tileHeight[index7][4] = 6;
      Minecart._tileHeight[index7][5] = 6;
      Minecart._tileHeight[index7][6] = 7;
      Minecart._tileHeight[index7][7] = 8;
      Minecart._texturePosition[index7] = new Vector2(0.0f, 1f);
      int index8 = index7 + 1;
      Minecart._leftSideConnection[index8] = 0;
      Minecart._rightSideConnection[index8] = 1;
      Minecart._tileHeight[index8][0] = 8;
      Minecart._tileHeight[index8][1] = 7;
      Minecart._tileHeight[index8][2] = 6;
      Minecart._tileHeight[index8][3] = 6;
      Minecart._texturePosition[index8] = new Vector2(1f, 1f);
      int index9 = index8 + 1;
      Minecart._leftSideConnection[index9] = 0;
      Minecart._rightSideConnection[index9] = 2;
      for (int index1 = 0; index1 < 8; ++index1)
        Minecart._tileHeight[index9][index1] = 8 - index1;
      Minecart._texturePosition[index9] = new Vector2(0.0f, 3f);
      int index10 = index9 + 1;
      Minecart._leftSideConnection[index10] = 2;
      Minecart._rightSideConnection[index10] = 0;
      for (int index1 = 0; index1 < 8; ++index1)
        Minecart._tileHeight[index10][index1] = index1 + 1;
      Minecart._texturePosition[index10] = new Vector2(1f, 3f);
      int index11 = index10 + 1;
      Minecart._leftSideConnection[index11] = 2;
      Minecart._rightSideConnection[index11] = -1;
      Minecart._tileHeight[index11][0] = 1;
      Minecart._tileHeight[index11][1] = 2;
      for (int index1 = 2; index1 < 8; ++index1)
        Minecart._tileHeight[index11][index1] = -1;
      Minecart._texturePosition[index11] = new Vector2(4f, 1f);
      int index12 = index11 + 1;
      Minecart._leftSideConnection[index12] = -1;
      Minecart._rightSideConnection[index12] = 2;
      Minecart._tileHeight[index12][6] = 2;
      Minecart._tileHeight[index12][7] = 1;
      for (int index1 = 0; index1 < 6; ++index1)
        Minecart._tileHeight[index12][index1] = -1;
      Minecart._texturePosition[index12] = new Vector2(5f, 1f);
      int index13 = index12 + 1;
      Minecart._leftSideConnection[index13] = 0;
      Minecart._rightSideConnection[index13] = -1;
      Minecart._tileHeight[index13][0] = 8;
      Minecart._tileHeight[index13][1] = 7;
      Minecart._tileHeight[index13][2] = 6;
      for (int index1 = 3; index1 < 8; ++index1)
        Minecart._tileHeight[index13][index1] = -1;
      Minecart._texturePosition[index13] = new Vector2(6f, 1f);
      int index14 = index13 + 1;
      Minecart._leftSideConnection[index14] = -1;
      Minecart._rightSideConnection[index14] = 0;
      Minecart._tileHeight[index14][5] = 6;
      Minecart._tileHeight[index14][6] = 7;
      Minecart._tileHeight[index14][7] = 8;
      for (int index1 = 0; index1 < 5; ++index1)
        Minecart._tileHeight[index14][index1] = -1;
      Minecart._texturePosition[index14] = new Vector2(7f, 1f);
      int index15 = index14 + 1;
      Minecart._leftSideConnection[index15] = -1;
      Minecart._rightSideConnection[index15] = 1;
      Minecart._tileHeight[index15][0] = -4;
      Minecart._texturePosition[index15] = new Vector2(2f, 0.0f);
      int index16 = index15 + 1;
      Minecart._leftSideConnection[index16] = 1;
      Minecart._rightSideConnection[index16] = -1;
      Minecart._tileHeight[index16][7] = -4;
      Minecart._texturePosition[index16] = new Vector2(3f, 0.0f);
      int index17 = index16 + 1;
      Minecart._leftSideConnection[index17] = 2;
      Minecart._rightSideConnection[index17] = -1;
      for (int index1 = 0; index1 < 6; ++index1)
        Minecart._tileHeight[index17][index1] = index1 + 1;
      Minecart._tileHeight[index17][6] = -3;
      Minecart._tileHeight[index17][7] = -3;
      Minecart._texturePosition[index17] = new Vector2(4f, 0.0f);
      int index18 = index17 + 1;
      Minecart._leftSideConnection[index18] = -1;
      Minecart._rightSideConnection[index18] = 2;
      Minecart._tileHeight[index18][0] = -3;
      Minecart._tileHeight[index18][1] = -3;
      for (int index1 = 2; index1 < 8; ++index1)
        Minecart._tileHeight[index18][index1] = 8 - index1;
      Minecart._texturePosition[index18] = new Vector2(5f, 0.0f);
      int index19 = index18 + 1;
      Minecart._leftSideConnection[index19] = 0;
      Minecart._rightSideConnection[index19] = -1;
      for (int index1 = 0; index1 < 6; ++index1)
        Minecart._tileHeight[index19][index1] = 8 - index1;
      Minecart._tileHeight[index19][6] = -3;
      Minecart._tileHeight[index19][7] = -3;
      Minecart._texturePosition[index19] = new Vector2(6f, 0.0f);
      int index20 = index19 + 1;
      Minecart._leftSideConnection[index20] = -1;
      Minecart._rightSideConnection[index20] = 0;
      Minecart._tileHeight[index20][0] = -3;
      Minecart._tileHeight[index20][1] = -3;
      for (int index1 = 2; index1 < 8; ++index1)
        Minecart._tileHeight[index20][index1] = index1 + 1;
      Minecart._texturePosition[index20] = new Vector2(7f, 0.0f);
      int index21 = index20 + 1;
      Minecart._leftSideConnection[index21] = -1;
      Minecart._rightSideConnection[index21] = -1;
      Minecart._tileHeight[index21][0] = -4;
      Minecart._tileHeight[index21][7] = -4;
      Minecart._trackType[index21] = 1;
      Minecart._texturePosition[index21] = new Vector2(0.0f, 4f);
      int index22 = index21 + 1;
      Minecart._leftSideConnection[index22] = 1;
      Minecart._rightSideConnection[index22] = 1;
      Minecart._trackType[index22] = 1;
      Minecart._texturePosition[index22] = new Vector2(1f, 4f);
      ...
      Minecart._texturePosition[index23] = new Vector2(0.0f, 5f);
      int index24 = index23 + 1;
      Minecart._leftSideConnection[index24] = 1;
      Minecart._rightSideConnection[index24] = -1;
      Minecart._tileHeight[index24][7] = -4;
      Minecart._trackType[index24] = 1;
      Minecart._texturePosition[index24] = new Vector2(1f, 5f);
      int index25 = index24 + 1;
      Minecart._leftSideConnection[index25] = -1;
      Minecart._rightSideConnection[index25] = 1;
      for (int index1 = 0; index1 < 6; ++index1)
        Minecart._tileHeight[index25][index1] = -2;
      Minecart._texturePosition[index25] = new Vector2(2f, 2f);
      int index26 = index25 + 1;
      Minecart._leftSideConnection[index26] = 1;
      Minecart._rightSideConnection[index26] = -1;
      for (int index1 = 2; index1 < 8; ++index1)
        Minecart._tileHeight[index26][index1] = -2;
      Minecart._texturePosition[index26] = new Vector2(3f, 2f);
      int index27 = index26 + 1;
      Minecart._leftSideConnection[index27] = 2;
      Minecart._rightSideConnection[index27] = -1;
      Minecart._tileHeight[index27][0] = 1;
      Minecart._tileHeight[index27][1] = 2;
      for (int index1 = 2; index1 < 8; ++index1)
        Minecart._tileHeight[index27][index1] = -2;
      Minecart._texturePosition[index27] = new Vector2(4f, 2f);
      int index28 = index27 + 1;
      Minecart._leftSideConnection[index28] = -1;
      Minecart._rightSideConnection[index28] = 2;
      Minecart._tileHeight[index28][6] = 2;
      Minecart._tileHeight[index28][7] = 1;
      for (int index1 = 0; index1 < 6; ++index1)
        Minecart._tileHeight[index28][index1] = -2;
      Minecart._texturePosition[index28] = new Vector2(5f, 2f);
      int index29 = index28 + 1;
      Minecart._leftSideConnection[index29] = 0;
      Minecart._rightSideConnection[index29] = -1;
      Minecart._tileHeight[index29][0] = 8;
      Minecart._tileHeight[index29][1] = 7;
      Minecart._tileHeight[index29][2] = 6;
      for (int index1 = 3; index1 < 8; ++index1)
        Minecart._tileHeight[index29][index1] = -2;
      Minecart._texturePosition[index29] = new Vector2(6f, 2f);
      int index30 = index29 + 1;
      Minecart._leftSideConnection[index30] = -1;
      Minecart._rightSideConnection[index30] = 0;
      Minecart._tileHeight[index30][5] = 6;
      Minecart._tileHeight[index30][6] = 7;
      Minecart._tileHeight[index30][7] = 8;
      for (int index1 = 0; index1 < 5; ++index1)
        Minecart._tileHeight[index30][index1] = -2;
      Minecart._texturePosition[index30] = new Vector2(7f, 2f);
      int index31 = index30 + 1;
      Minecart._leftSideConnection[index31] = 1;
      Minecart._rightSideConnection[index31] = 1;
      Minecart._trackType[index31] = 2;
      Minecart._boostLeft[index31] = false;
      Minecart._texturePosition[index31] = new Vector2(2f, 3f);
      int index32 = index31 + 1;
      Minecart._leftSideConnection[index32] = 1;
      Minecart._rightSideConnection[index32] = 1;
      Minecart._trackType[index32] = 2;
      Minecart._boostLeft[index32] = true;
      Minecart._texturePosition[index32] = new Vector2(3f, 3f);
      int index33 = index32 + 1;
      Minecart._leftSideConnection[index33] = 0;
      Minecart._rightSideConnection[index33] = 2;
      for (int index1 = 0; index1 < 8; ++index1)
        Minecart._tileHeight[index33][index1] = 8 - index1;
      Minecart._trackType[index33] = 2;
      Minecart._boostLeft[index33] = false;
      Minecart._texturePosition[index33] = new Vector2(4f, 3f);
      int index34 = index33 + 1;
      Minecart._leftSideConnection[index34] = 2;
      Minecart._rightSideConnection[index34] = 0;
      for (int index1 = 0; index1 < 8; ++index1)
        Minecart._tileHeight[index34][index1] = index1 + 1;
      Minecart._trackType[index34] = 2;
      Minecart._boostLeft[index34] = true;
      Minecart._texturePosition[index34] = new Vector2(5f, 3f);
      ...
      Minecart._boostLeft[index35] = true;
      Minecart._texturePosition[index35] = new Vector2(6f, 3f);
      ...
      Minecart._boostLeft[index36] = false;
      Minecart._texturePosition[index36] = new Vector2(7f, 3f);
      num1 = index36 + 1;
      ...
      for (int index1 = 0; index1 < 64; ++index1)
      {
        ...
        if (length != 0)
        {
          ...
          {
            if (numArray1[index37] != -1)
            {
              numArray2[index2] = numArray1[index37];
              ++index2;
            }
          }
