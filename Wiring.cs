                  ...
                  case 3:
                    if (Wiring.CheckMech(i, j, 300))
                    {
                      ...
                      if (num2 > 0)
                      {
                        ...
                        vector2.Y += 6f;
                        Projectile.NewProjectile((float) (int) vector2.X, (float) (int) vector2.Y, SpeedX, SpeedY, Type, 40, 2f, Main.myPlayer, 0.0f, 0.0f);
                        break;
                      }
                      break;
                    }
