      ...
      else
      {
        ...
        switch (num1)
        {
          ...
          case 51:
            ...
            switch (num56)
            {
              ...
              case 2:
                ...
                Main.PlaySound(SoundID.Item1, (int) Main.player[(int) num55].position.X, (int) Main.player[(int) num55].position.Y);
                return;
              case 3:
                if (Main.netMode != 2)
                  return;
          ...
          case 52:
            ...
            if (num57 == 1)
            {
              ...
              if (Main.netMode == 2)
              {
                ...
                NetMessage.SendTileSquare(-1, num58, num59, 2, TileChangeType.None);
              }
            }
            if (num57 != 2)
              break;
          ...
          case 63:
            ...
            WorldGen.paintTile(num63, y4, color3, false);
            if (Main.netMode != 2)
              break;
            NetMessage.SendData(63, -1, this.whoAmI, "", num63, (float) y4, (float) color3, 0.0f, 0, 0, 0);
            break;
          case 64:
            int num64 = (int) this.reader.ReadInt16();
            int y5 = (int) this.reader.ReadInt16();
            byte color4 = this.reader.ReadByte();
            WorldGen.paintWall(num64, y5, color4, false);
            if (Main.netMode != 2)
              break;
            NetMessage.SendData(64, -1, this.whoAmI, "", num64, (float) y5, (float) color4, 0.0f, 0, 0, 0);
            break;
          case 65:
            ...
            if (bitsByte18[3])
              num66 += 2;
            if (num65 == 0)
              Main.player[index23].Teleport(vector2_7, num66, 0);
            else if (num65 == 1)
              Main.npc[index23].Teleport(vector2_7, num66, 0);
            else if (num65 == 2)
            {
              Main.player[index23].Teleport(vector2_7, num66, 0);
              if (Main.netMode == 2)
              {
                ...
                NetMessage.SendData(65, -1, -1, "", 0, (float) index23, vector2_7.X, vector2_7.Y, num66, 0, 0);
                int index4 = -1;
                float num37 = 9999f;
            ...
            if (Main.netMode != 2 || num65 != 0)
              break;
            NetMessage.SendData(65, -1, this.whoAmI, "", 0, (float) index23, vector2_7.X, vector2_7.Y, num66, 0, 0);
            break;
          case 66:
          ...
          case 80:
            ...
            if (num69 < -3 || num69 >= 1000)
              break;
            Main.player[index24].chest = num69;
            Recipe.FindRecipes();
            break;
          case 81:
            if (Main.netMode != 1)
          ...
          case 84:
            ...
            Main.player[number33].stealth = num71;
            if (Main.netMode != 2)
              break;
          ...
          case 85:
            ...
            byte num72 = this.reader.ReadByte();
            if (Main.netMode != 2 || whoAmI1 >= (int) byte.MaxValue || (int) num72 >= 58)
              break;
            Chest.ServerPlaceItem(this.whoAmI, (int) num72);
            break;
          case 86:
            if (Main.netMode != 1)
              break;
          ...
          case 87:
            ...
            if (!WorldGen.InWorld(num73, num74, 0) || TileEntity.ByPosition.ContainsKey(new Point16(num73, num74)))
              break;
            TileEntity.PlaceEntityNet(num73, num74, type10);
            break;
          case 88:
            if (Main.netMode != 1)
              break;
          ...
          case 91:
            ...
            int num75 = 0;
            if (emotion < 0)
              num75 = (int) this.reader.ReadInt16();
            ...
            lock (EmoteBubble.byID)
            {
              ...
              EmoteBubble.byID[key2].metadata = num75;
              break;
            }
          case 92:
            ...
            if (Main.netMode == 1)
            {
              Main.npc[number34].moneyPing(new Vector2(num77, num78));
              Main.npc[number34].extraValue = num76;
              break;
            }
            Main.npc[number34].extraValue += num76;
            NetMessage.SendData(92, -1, -1, "", number34, Main.npc[number34].extraValue, num77, num78, 0, 0, 0);
            break;
          case 95:
            ushort num79 = this.reader.ReadUInt16();
            if (Main.netMode != 2 || (int) num79 < 0 || (int) num79 >= 1000)
              break;
            Projectile projectile2 = Main.projectile[(int) num79];
          ...
          case 96:
            ...
            int num80 = extraInfo1 + (extraInfo1 % 2 == 0 ? 1 : -1);
            player15.lastPortalColorIndex = num80;
          ...
          case 100:
            ...
            int num81 = extraInfo2 + (extraInfo2 % 2 == 0 ? 1 : -1);
            npc3.lastPortalColorIndex = num81;
          ...
          case 102:
            ...
            if (Main.netMode == 2)
            {
              NetMessage.SendData(102, -1, -1, "", this.whoAmI, (float) num82, Other.X, Other.Y, 0, 0, 0);
              break;
            }
            ...
            for (int index4 = 0; index4 < (int) byte.MaxValue; ++index4)
            {
              ...
              if (player8.active && !player8.dead && (player16.team == 0 || player16.team == player8.team) && (double) player8.Distance(Other) < 700.0)
              {
                ...
                player8.NebulaLevelup((int) num82);
              }
            }
            break;
          case 103:
          ...
          case 104:
            ...
            objArray[index31].stack = num83;
            objArray[index31].Prefix(pre3);
            objArray[index31].value = num84;
          ...
          case 110:
            ...
            for (int index4 = 0; index4 < num86; ++index4)
          ...
          case 112:
            ...
            if (number36 != 1)
              break;
            if (Main.netMode == 1)
              WorldGen.TreeGrowFX(x6, y10, height, num87);
            if (Main.netMode != 2)
              break;
            NetMessage.SendData((int) num1, -1, -1, "", number36, (float) x6, (float) y10, (float) height, num87, 0, 0);
            break;
          case 113:
          ...
          case 117:
            ...
            int num90 = (int) this.reader.ReadSByte();
            Main.player[playerTargetIndex1].Hurt(playerDeathReason1, num88, num89, pvp2, true, flag9, num90);
            if (Main.netMode != 2)
              break;
            NetMessage.SendPlayerHurt(playerTargetIndex1, playerDeathReason1, num88, num89, flag9, pvp2, num90, -1, this.whoAmI);
            break;
          case 118:
            ...
            int num91 = (int) this.reader.ReadByte() - 1;
            bool pvp3 = ((BitsByte)this.reader.ReadByte())[0];
            Main.player[playerTargetIndex2].KillMe(playerDeathReason2, (double) damage, num91, pvp3);
            if (Main.netMode != 2)
              break;
            NetMessage.SendPlayerDeath(playerTargetIndex2, playerDeathReason2, damage, num91, pvp3, -1, this.whoAmI);
            break;
        }
      }
    }
