...
namespace Terraria
{
  public class Recipe
  {
    ...
    {
      RecipeGroupID.Birds = RecipeGroup.RegisterGroup("Birds", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Main.npcName[74]), new int[3]{ 2015, 2016, 2017 }));
      RecipeGroupID.Scorpions = RecipeGroup.RegisterGroup("Scorpions", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Main.npcName[367]), new int[2]{ 2157, 2156 }));
      RecipeGroupID.Squirrels = RecipeGroup.RegisterGroup("Squirrels", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Main.npcName[299]), new int[2]{ 2018, 3563 }));
      RecipeGroupID.Bugs = RecipeGroup.RegisterGroup("Bugs", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[85]), new int[3]{ 3194, 3192, 3193 }));
      RecipeGroupID.Ducks = RecipeGroup.RegisterGroup("Ducks", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[86]), new int[2]{ 2123, 2122 }));
      ...
      RecipeGroupID.Fireflies = RecipeGroup.RegisterGroup("Fireflies", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[88]), new int[2]{ 1992, 2004 }));
      RecipeGroupID.Snails = RecipeGroup.RegisterGroup("Snails", new RecipeGroup((Func<string>) (() => Lang.misc[37] + " " + Lang.misc[95]), new int[2]{ 2006, 2007 }));
    }
    ...
    public static void SetupRecipes()
    {
      ...
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2679, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1970, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2680, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1970, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      ...
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2689, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1971, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2690, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1971, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      ...
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2687, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1972, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2688, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1972, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      ...
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2683, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1973, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2684, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1973, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      ...
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2685, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1974, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2686, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1974, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      ...
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2681, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1975, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2682, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1975, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      ...
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2677, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1976, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      Recipe.newRecipe.createItem.SetDefaults(2678, false);
      Recipe.newRecipe.createItem.stack = 4;
      Recipe.newRecipe.requiredItem[0].SetDefaults(1976, false);
      Recipe.newRecipe.requiredTile[0] = 18;
      Recipe.AddRecipe();
      ...
      Recipe.newRecipe.requiredTile[0] = 16;
      Recipe.AddRecipe();
      for (int Type = 3665; Type <= 3704; ++Type)
      {
        Recipe.newRecipe.createItem.SetDefaults(Type, false);
        Recipe.newRecipe.requiredItem[0].SetDefaults(ItemID.Sets.TextureCopyLoad[Type], false);
      ...
      Recipe.newRecipe.anyWood = true;
      Recipe.AddRecipe();
      for (int Type = 2114; Type <= 2118; ++Type)
      {
        Recipe.newRecipe.createItem.SetDefaults(Type, false);
        Recipe.newRecipe.requiredItem[0].SetDefaults(9, false);
        Recipe.newRecipe.requiredItem[0].stack = 12;
      ...
      for (int index1 = 0; index1 < numArray.GetLength(0); ++index1)
      {
        ...
        int Type = numArray[index1, 2];
        if (Type != -1)
        {
          int index4;
          Recipe.newRecipe.requiredItem[index4 = index2 + 1].SetDefaults(Type, false);
