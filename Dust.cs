...
namespace Terraria
{
  public class Dust
  {
    ...
    public static Dust NewDustPerfect(Vector2 Position, int Type, Vector2? Velocity = null, int Alpha = 0, Color newColor = new Color(), float Scale = 1f)
    {
    ...
    public static Dust NewDustDirect(Vector2 Position, int Width, int Height, int Type, float SpeedX = 0.0f, float SpeedY = 0.0f, int Alpha = 0, Color newColor = new Color(), float Scale = 1f)
    {
    ...
    public static int NewDust(Vector2 Position, int Width, int Height, int Type, float SpeedX = 0.0f, float SpeedY = 0.0f, int Alpha = 0, Color newColor = new Color(), float Scale = 1f)
    {
      if (Main.gameMenu)
        return 6000;
      if (Main.rand == null)
    ...
    public Color GetAlpha(Color newColor)
    {
      ...
      if (this.type != 213 && this.type != 260)
      {
        ...
        if (this.type != 160 && this.type != 162 && (this.type != 164 && this.type != 173))
        {
          ...
          if (this.type != 226 && this.type != 272)
          {
            ...
            if (this.type != 229 && this.type != 269)
            {
              ...
              if (this.type == 157)
              {
                float num2 = (float) ((double) Main.mouseTextColor / 100.0 - 1.60000002384186);
                int num3 = (int) ((double) byte.MaxValue * (double) num2);
                int num4 = (int) ((double) byte.MaxValue * (double) num2);
                int num5 = (int) ((double) byte.MaxValue * (double) num2);
                int a = (int) (100.0 * (double) num2);
                int r = num3 + 50;
        ...
        int num6 = (int) (250.0 * (double) this.scale);
        return new Color(num6, num6, num6, 0);
      }
      int num7 = (int) ((double) this.scale / 2.5 * (double) byte.MaxValue);
