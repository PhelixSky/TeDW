...
namespace Terraria.UI.Chat
{
  public class TextSnippet
  {
    ...
    public virtual bool UniqueDraw(bool justCheckingString, out Vector2 size, SpriteBatch spriteBatch, Vector2 position = new Vector2(), Color color = new Color(), float scale = 1f)
    {
      size = Vector2.Zero;
      return false;
    }
