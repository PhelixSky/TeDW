...
namespace Terraria.Map
{
  public static class MapHelper
  {
    ...
    public static void Initialize()
    {
      ...
      ushort num4 = 1;
      MapHelper.tilePosition = (ushort) 1;
    ...
    {
      bool isCloudSave;
      if ((isCloudSave = Main.ActivePlayerFileData.IsCloudSave) && SocialAPI.Cloud == null || (!Main.mapEnabled || MapHelper.saveLock))
        return;
