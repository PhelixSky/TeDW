...
namespace Terraria.GameContent.UI.Elements
{
  public class UIWorldListItem : UIPanel
  {
    ...
    protected override void DrawSelf(SpriteBatch spriteBatch)
    {
      ...
      float x4 = (float) (70.0 - (double) Main.fontMouseText.MeasureString(textValue1).X * 0.5);
      Utils.DrawBorderString(spriteBatch, textValue1, position + new Vector2(x4, 3f), Color.White, 1f, 0.0f, 0.0f, -1);
      position.X += 145f;
      ...
      float x6 = (float) ((double) width3 * 0.5 - (double) x5 * 0.5);
      Utils.DrawBorderString(spriteBatch, textValue2, position + new Vector2(x6, 3f), Color.White, 1f, 0.0f, 0.0f, -1);
