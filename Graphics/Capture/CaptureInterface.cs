  ...
  public class CaptureInterface
  {
    ...
    public void Update()
    {
      ...
      if (CaptureInterface.CameraLock)
        return;
      bool flag;
      if ((flag = Main.keyState.IsKeyDown(Keys.F1)) && !this.KeyToggleActiveHeld && (Main.mouseItem.type == 0 || this.Active) && !Main.CaptureModeDisabled)
    ...
    private bool UpdateButtons(Vector2 mouse)
    {
      ...
      for (int index = 0; index < num1; ++index)
      {
        if (new Rectangle(24 + 46 * index, 24, 42, 42).Contains(mouse.ToPoint()))
        {
          ...
          if (num10 == num11 && flag2 && this.SelectedMode != 0)
          {
            this.SelectedMode = 0;
          ...
          if (num14 == num15 && flag2 && this.SelectedMode != 1)
          {
            this.SelectedMode = 1;
            this.ToggleCamera(true);
          }
          ...
          if (num18 == num19 && flag2)
            CaptureInterface.ResetFocus();
          int num22 = index;
          int num23 = num21;
          int num24 = 1;
          int num25 = num23 + num24;
          if (num22 == num23 && flag2 && Main.mapEnabled)
            Main.mapFullscreen = !Main.mapFullscreen;
          int num26 = index;
          int num27 = num25;
          int num28 = 1;
          int num29 = num27 + num28;
          if (num26 == num27 && flag2 && this.SelectedMode != 2)
          {
            this.SelectedMode = 2;
            this.ToggleCamera(true);
          }
    ...
    private static bool GetMapCoords(int PinX, int PinY, int Goal, out Point result)
    {
      ...
      float num8 = (float) ((double) Main.screenWidth / (double) Main.maxTilesX * 0.800000011920929);
      if ((double) Main.mapFullscreenScale < (double) num8)
      ...
      float num9 = x1 * mapFullscreenScale;
      float num10 = y1 * mapFullscreenScale;
      float num11 = -num9 + (float) (Main.screenWidth / 2);
      float num12 = -num10 + (float) (Main.screenHeight / 2);
      float x2 = num11 + num4 * mapFullscreenScale;
      float y2 = num12 + num5 * mapFullscreenScale;
      float num13 = (float) (Main.maxTilesX / 840) * Main.mapFullscreenScale;
      float num14 = x2;
      float num15 = y2;
      ...
      {
        float num20 = num13 * 0.999f;
        num16 = num14 - 40.6f * num20;
        num17 = y2 - 5f * num20;
        num18 = (width - 8.045f) * num20;
        float num21 = (height + 0.12f) * num20;
        if ((double) num20 < 1.2)
          num19 = num21 + 1f;
      }
      else if (Main.maxTilesX == 6400)
      {
        float num20 = num13 * 1.09f;
        num16 = num14 - 38.8f * num20;
        num17 = y2 - 3.85f * num20;
        num18 = (width - 13.6f) * num20;
        float num21 = (height - 6.92f) * num20;
        if ((double) num20 < 1.2)
          num19 = num21 + 2f;
      }
      ...
      {
        float num20 = num13 * 1.09f;
        num16 = num14 - 39.8f * num20;
        num17 = y2 - 4.08f * num20;
        num18 = (width - 26.69f) * num20;
        float num21 = (height - 6.92f) * num20;
        if ((double) num20 < 1.2)
          num19 = num21 + 2f;
      }
      ...
      {
        float num20 = num13 * 0.998f;
        num16 = num14 - 37.3f * num20;
        num17 = num15 - 1.7f * num20;
        num18 = (width - 16f) * num20;
        num19 = (height - 8.31f) * num20;
      }
      if (Goal == 0)
      {
        int x3 = (int) ((-(double) x2 + (double) PinX) / (double) mapFullscreenScale + (double) num4);
        int y3 = (int) ((-(double) y2 + (double) PinY) / (double) mapFullscreenScale + (double) num5);
        bool flag = false;
        if ((double) x3 < (double) num4)
          flag = true;
        if ((double) x3 >= (double) num6)
          flag = true;
        if ((double) y3 < (double) num5)
          flag = true;
