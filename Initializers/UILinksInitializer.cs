  ...
  public class UILinksInitializer
  {
    ...
    public static void Load()
    {
      ...
      cp6.UpdateEvent += (Action) (() =>
      {
        ...
        {
          UILinkPoint link = cp6.LinkMap[303];
          cp6.LinkMap[303].Right = 304;
          int num = 304;
          link.Left = num;
        }
        else
      ...
      cp10.LinkMap[1501].OnSpecialInteracts += (Func<string>) (() =>
      {
        ...
        bool flag2;
        if ((flag2 = Main.mouseItem.stack <= 0) || Main.mouseItem.type == Main.recipe[Main.availableRecipe[Main.focusRecipe]].createItem.type && Main.mouseItem.stack < Main.mouseItem.maxStack)
        {
          if (flag2)
      ...
      cp12.UpdateEvent += (Action) (() =>
      {
        int num1 = 5;
        int num2 = 15;
        int num3 = Main.UnlockedMaxHair();
        for (int index = 0; index < num2; ++index)
        {
          cp12.LinkMap[2605 + index].Left = index % num1 == 0 ? -3 : 2605 + index - 1;
          cp12.LinkMap[2605 + index].Right = (index + 1) % num1 == 0 || index == num3 - 1 ? -4 : 2605 + index + 1;
          cp12.LinkMap[2605 + index].Down = index < num2 - num1 ? 2605 + index + num1 : -2;
      ...
      UILinkPage uiLinkPage1 = cp13;
      UILinkPage uiLinkPage2 = cp13;
      int num4 = 1002;
      int num5 = 1002;
      uiLinkPage2.PageOnRight = num4;
      int num6 = 1002;
      uiLinkPage1.PageOnLeft = num6;
      ...
      UILinkPage uiLinkPage3 = cp14;
      UILinkPage uiLinkPage4 = cp14;
      int num7 = 1001;
      num5 = 1001;
      uiLinkPage4.PageOnRight = num7;
      int num8 = 1001;
      uiLinkPage3.PageOnLeft = num8;
    ...
    public static void HandleOptionsSpecials()
    {
      switch (UILinkPointNavigator.Shortcuts.OPTIONS_BUTTON_SPECIALFEATURE)
      {
        ...
        case 9:
          ...
          {
            if (UILinksInitializer.SomeVarsForUILinkers.HairMoveCD > 0)
